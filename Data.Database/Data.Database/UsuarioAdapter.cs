...
//            Usuarios.Remove(this.GetOne(ID));
        ...
        protected void Update(Usuario usuario)
        {
            try
            {
                ...
                cmdSave.Parameters.Add("@havilitado", SqlDbType.Bit).Value = usuario.Habilitado;
        ...
        protected void Insert(Usuario usuario)
        {
            try
            {
                ...
                SqlCommand cmdSave = new SqlCommand("insert into usuarios(nombre_usuario, clave, habilitado, nombre, apellido, email) " +
                    ...
                    "select @@identity", //recupera id asiganada por sql automáticamente
                    sqlConn);
                ...
                cmdSave.Parameters.Add("@apellido", SqlDbType.VarChar, 50).Value = usuario.Apellido;
                cmdSave.Parameters.Add("@email", SqlDbType.VarChar, 50).Value = usuario.Email;
                usuario.ID = Decimal.ToInt32((Decimal)cmdSave.ExecuteScalar());  //Para la ID Automática
